...
pub struct FileVideoMediaMetadata {
    /// i64: Output only. The duration of the video in milliseconds.
...
pub struct File {
    ...
    /// DateTime: he last time the file was modified by anyone (RFC 3339 date-time). Note that setting modifiedTime will also update modifiedByMeTime for the user.
    #[serde(rename = "modifiedTime")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub modified_time: Option<DateTime<Utc>>,
    ...
    /// i64: Output only. The number of storage quota bytes used by the file. This includes the head revision as well as previous revisions with `keepForever` enabled.
    ...
    /// i64: Output only. Size in bytes of blobs and first party editor files. Won't be populated for files that have no size, like shortcuts and folders.
    #[serde(rename = "size")]
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    /// i64: Output only. The thumbnail version for use in thumbnail cache invalidation.
    ...
    /// i64: Output only. A monotonically increasing version number for the file. This reflects every change made to the file on the server, even those not visible to the user.
...
pub struct LabelField {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub date_string: Option<Vec<String>>,
...
pub struct Revision {
    ...
    /// i64: Output only. The size of the revision's content in bytes. This is only applicable to files with binary content in Drive.
    #[serde(rename = "size")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub size: Option<String>,
}
...
#[derive(Debug, Clone, Copy, Serialize, Deserialize)]
pub enum DriveParamsdollar_xgafv {
    Undefined,
    /// v1 error format
    #[serde(rename = "1")]
    _1,
...
impl std::default::Default for DriveParamsdollar_xgafv {
    fn default() -> DriveParamsdollar_xgafv {
        DriveParamsdollar_xgafv::Undefined
    }
}

impl std::fmt::Display for DriveParamsdollar_xgafv {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let s = match self {
            DriveParamsdollar_xgafv::Undefined => write!(f, "undefined"),
            DriveParamsdollar_xgafv::_1 => write!(f, "1"),
            DriveParamsdollar_xgafv::_2 => write!(f, "2"),
        };
        Ok(())
    }
}
...
impl std::fmt::Display for DriveParamsAlt {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let s = match self {
            ...
            DriveParamsAlt::Proto => write!(f, "proto"),
        };
        Ok(())
    }
}
...
impl std::fmt::Display for ChangesListParams {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        if let Some(ref v) = self.include_labels {
            write!(
                f,
                "&includeLabels={}",
                percent_encode(format!("{}", v).as_bytes(), NON_ALPHANUMERIC).to_string()
...
pub struct DrivesDeleteParams {
    ...
    #[serde(rename = "allowItemDeletion")]
    pub allow_item_deletion: Option<bool>,
...
impl std::fmt::Display for DrivesDeleteParams {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        if let Some(ref v) = self.allow_item_deletion {
            write!(
                f,
                "&allowItemDeletion={}",
                percent_encode(format!("{}", v).as_bytes(), NON_ALPHANUMERIC).to_string()
...
/// Parameters for the `files.listLabels` method.
#[derive(Serialize, Deserialize, Debug, Clone, Default)]
pub struct FilesListLabelsParams {
    /// General attributes applying to any API call
    #[serde(flatten)]
    pub drive_params: Option<DriveParams>,
...
impl std::fmt::Display for FilesListLabelsParams {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
...
/// Parameters for the `files.modifyLabels` method.
#[derive(Serialize, Deserialize, Debug, Clone, Default)]
pub struct FilesModifyLabelsParams {
    /// General attributes applying to any API call
    #[serde(flatten)]
    pub drive_params: Option<DriveParams>,
...
impl std::fmt::Display for FilesModifyLabelsParams {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        Ok(())
    }
}
...
pub struct DriveParams {
    ...
    #[serde(rename = "$.xgafv")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub dollar_xgafv: Option<DriveParamsdollar_xgafv>,
    /// OAuth access token.
...
impl FilesService {
    ...
    pub async fn list_labels(&self, params: &FilesListLabelsParams) -> Result<LabelList> {
        let rel_path = format!(
    ...
    pub async fn modify_labels(
        &self,
        params: &FilesModifyLabelsParams,
        req: &ModifyLabelsRequest,
    ) -> Result<ModifyLabelsResponse> {
        let rel_path = format!(
        ...
        let tok;
        if self.scopes.is_empty() {
            let scopes = &[DriveScopes::DriveMetadata.as_ref().to_string()];
            tok = self.authenticator.token(scopes).await?;
        } else {
            tok = self.authenticator.token(&self.scopes).await?;
        }
    ...
    pub async fn watch(&self, params: &FilesWatchParams, req: &Channel) -> Result<Channel> {
        let rel_path = format!(
            "files/{fileId}/watch",
            fileId = percent_encode(format!("{}", params.file_id).as_bytes(), NON_ALPHANUMERIC)
        );
